...
def run():
    ...
    """
    inputs = {
        'topic': 'plan a 3-day trip to Paris for a family of 4 in June, including flights, hotel, and sightseeing recommendations. Provide a detailed itinerary with options for each day.',
        'destination': 'Paris',
